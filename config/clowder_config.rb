...
class ClowderConfig
  ...
  def self.instance
    @instance ||= {}.tap do |options|
      ...
      options["INACTIVE_TASK_REMINDER_TIME"] = (ENV["INACTIVE_TASK_REMINDER_TIME"] || 30).to_i # in minutes
      options["SOURCE_REFRESH_TIMEOUT"] = (ENV["SOURCE_REFRESH_TIMEOUT"] || 30).to_i # in minutes
      options["CHECK_AVAILABILITY_TIMEOUT"] = (ENV["CHECK_AVAILABILITY_TIMEOUT"] || 30).to_i # in minutes
    end
  end
