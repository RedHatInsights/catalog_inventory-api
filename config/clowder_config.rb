...
class ClowderConfig
  ...
  def self.instance
    @instance ||= {}.tap do |options|
      ...
      options["SOURCE_REFRESH_TIMEOUT"] = (ENV["SOURCE_REFRESH_TIMEOUT"] || 10).to_i # in minutes
      options["CHECK_AVAILABILITY_TIMEOUT"] = (ENV["CHECK_AVAILABILITY_TIMEOUT"] || 10).to_i # in minutes
    end
  end
